# Übungen: Variablen und Datentypen in Java
...
- Erstelle eine Variable vom Typ `double` mit dem Namen `doubelZahl` und weise ihr den Wert `45.78` zu.
- Konvertiere diese Variable in eine `int`-Variable namens `intDouble`: `int intZahl = (int) doubelZahl;`
- Gib beide Werte (vor und nach der Umwandlung) auf der Konsole aus.
- Was passiert mit den Nachkommastellen?
